...
import cs3500.pa01.notesparser.SortByFilename;
...
/**
 * Tests sorting by filename.
 */
public class SortByFilenameTest {
  ...
  public void setup() throws ParseException {
    ...
    vectors = new MarkdownFile(
        Path.of("src/test/resources/notes/extendedNotes/vectors.md"),
        "vectors.md",
  ...
  /**
   * Tests if SortByFilename sorts files correctly.
   */
  @Test
  public void testComparator() {
    files.sort(new SortByFilename());
    assertEquals(List.of(arrays, formatting, regex, regexDup, vectors), files);
